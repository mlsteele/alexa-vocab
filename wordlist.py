...
words = [
    ...
    Word(word="Fain", definition="Pleased or willing under the circumstances. Compelled by circumstances. Or as an adverb: glady"),
    ...
    Word(word="Vaporetto", definition="(in Venice) a canal boat (originally a steamboat, now a motorboat) used for public transportation."),
    ...
    Word(word="Wiggy", definition="Emotionally uncontrolled or weird."),
    ...
    Word(word="Head frame", definition="The structural frame above an underground mine shaft. Also called: gallows frame, winding tower, hoist frame, pit frame, shafthead frame, headgear, headstock, or poppethead"),
